...
const users = [
    {
        name: "Alice",
        profile: "https://placehold.co/200x/ffa8e4/ffffff.svg?text=ʕ•́ᴥ•̀ʔ&font=Lato",
        lastMsg: "Hoorayy!!"
    },
    {
        name: "Alice",
    ...
    <div>
        <div className='h-[calc(100vh-115px)]  w-[100%] flex'>
                ...
                <div>
                    {
                        users.map((user, index)=>(
                            <div class="flex items-center my-2 cursor-pointer hover:bg-gray-100 p-2 rounded-md border-b">
            ...
            <div className='w-[70%] h-[100%] bg-white border-2 rounded-lg flex flex-col'>
                <div className='h-12 p-3 rounded-t-lg border-b-2'>
                    <h2 className='font-bold text-xl'>Sanjay Prajapat</h2>
                </div>
            ...
            <div class="flex mb-4 cursor-pointer">
                ...
                <div class="flex max-w-96 bg-white rounded-lg p-3 gap-3 border">
...
{/* <div class="flex flex-col h-[100%] w-40% md:w-1/2 lg:w-2/5 border-r border-gray-300">
            <div class=" bg-white border-r border-gray-300">
                ...
                <div class="overflow-y-auto flex flex-col flex-1 p-3 mb-9 pb-20">
        ...
        <div class="flex-grow h-[100%] overflow-y-auto p-4 pb-36">
            <header class="bg-white p-4 text-gray-700">
                <h1 class="text-2xl font-semibold">Alice</h1>
            </header>
            
            <div class="flex-grow overflow-y-auto p-4 pb-36">
            <div class="flex mb-4 cursor-pointer">
                <div class="w-9 h-9 rounded-full flex items-center justify-center mr-2">
                <img src="https://placehold.co/200x/ffa8e4/ffffff.svg?text=ʕ•́ᴥ•̀ʔ&font=Lato" alt="User Avatar" class="w-8 h-8 rounded-full" />
                </div>
            ...
            <footer class="bg-white border-t border-gray-300 p-4 w-[100%]">
                <div class="flex items-center">
                    <input type="text" placeholder="Type a message..." class="w-full p-2 rounded-md border border-gray-400 focus:outline-none focus:border-blue-500" />
                    <button class="bg-indigo-500 text-white px-4 py-2 rounded-md ml-2">Send</button>
                </div>
